...
Thanks to Titas Geryba for the implementation (with slight edits)!


NB: for list comprehensions operating on md-arrays, put the
corresponding loops within the corresponding lists.
"""
